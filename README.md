<div align="center">
  <br />
    <a href="https://github.com/menoc61/library-management">
  ...
  <h3 align="center">A University Library Management System with Admin Panel</h3>
   ...
   <div align="center">
  The figma link is accessible on the following link: <a href="https://www.figma.com/design/ABkjT2ptyvXomNbBNiLWo9/Library-Management-System-(v1)1o?node-id=2-2&p=f&t=eZvfyIshE2BVleNE-0" target="_blank">Figma</a>
    </div>
</div>
...
```bash
git clone https://github.com/menoc61/library-management.git
